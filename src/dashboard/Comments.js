...
export default function Comments() {
  ...
  return (
    ...
    <div className="text-center mb-8">
      <h1 className="text-3xl font-semibold text-blue-100">Comments</h1>
      <p className="text-lg text-gray-200 mt-2">Share your thoughts below</p>
    </div>
  
    {/* Add Comment Button */}
    <div className="flex justify-center mb-6">
      <Button onClick={() => setShowModal(true)} type="none" className="text-white py-5 px-6 font-semibold hover:border-gray-100 bg-blue-600 hover:bg-blue-500">
        Add Comment
      </Button>
    </div>
      ...
      {comments.map((comment) => (
        ...
        >
          ...
          <div className="flex items-center space-x-4 bg-gray-100 rounded-full py-2">
            <Avatar size={40} className="bg-blue-500 text-white">
