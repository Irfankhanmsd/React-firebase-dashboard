    ...
    <>
      ...
      <div className="flex justify-center items-center">
        <div className="w-full max-w-md">
          <Form
            form={form}
            className="px-6 py-4 bg-blue-100 shadow-md rounded-lg"
            layout="vertical"
            style={{ width: "100%" }}
          >
            <Form.Item
            ...
            <Form.Item>
              <Button type="none" className="px-5 py-2 bg-blue-600 text-white  hover:bg-gray-800" onClick={save} loading={saveLoader}>
                Save
              </Button>
            </Form.Item>
          </Form>
