  ...
  return (
    <div className="max-w-4xl mx-auto md:p-0 pt-10">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-blue-100">Todo List</h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center mb-6">
        ...
        <Button
          ...
          className="mt-4 md:mt-0 md:ml-4 w-full md:w-auto py-5 bg-blue-600 hover:bg-blue-500 hover:border-white text-white font-semibold text-lg"
        >
